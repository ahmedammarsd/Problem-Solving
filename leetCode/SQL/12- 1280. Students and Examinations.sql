...
-- WHERE st.student_id = ex.student_id AND sb.subject_name = ex.subject_name

-- SELECT ex.student_id , COUNT(ex.student_id) AS attended_exams
-- FROM Examinations ex
-- INNER JOIN Subjects sb ON sb.subject_name = ex.subject_name
